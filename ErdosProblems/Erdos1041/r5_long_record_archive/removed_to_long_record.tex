% Original passages replaced by round-five surgical edits.
% Destination map is in 03_long_record_map.md. This file is an archive, not a manuscript.

% A1 | abstract; sec:problem; sec:trinomial; glance and source blocks, lines 36–327
\begin{abstract}
\noindent
...
% A2 | sec:constant-factor; res:low-critical-thirteen-twentyfifths; res:constant-factor-path, lines 328–532
...
% A3 | sec:freepoint; res:fp-weighted-all-degree; res:fp-to-s, lines 1283–1448
...
% A5 | sec:evidence-ledger, lines 1913–2091
...
% A9 | sec:reciprocal; res:reciprocal-expansion; res:reciprocal-rationality; res:staple-contact, lines 886–1084
...
% A10 | sec:orlicz; res:orlicz-currency; res:orlicz-selector, lines 1449–1596
...
% A12 | sec:finite, lines 1146–1168
